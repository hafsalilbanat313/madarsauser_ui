    ...
    <div className="bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50 p-4 md:p-6">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-600 font" style={{ fontFamily: "Poppins" }}>
          ...
          {cards.map((c, i) => {
            ...
            return (
              ...
              >
                {/* Icon Container */}
                <div
                  className={`${c.bgLight} w-14 h-14 rounded-xl flex items-center justify-center mb-4 group-hover:scale-110 transition-transform duration-300`}
                >
                ...
                <div
                  className={`absolute inset-0 rounded-2xl bg-gradient-to-r ${c.gradient} opacity-0 group-hover:opacity-10 transition-opacity duration-300 pointer-events-none`}
                ></div>
              </div>
            );
          })}
