...
const handleFileChange = (e) => {
  ...
  const validate = () => {
    ...
    if (!form.studentName.trim())
      err.studentName = "Student name is required";
    ...
    if (!form.classApplied)
      err.classApplied = "Class is required";

    if (!form.fatherName)
      err.fatherName = "Father name is required";

    if (!form.motherName)
      err.motherName = "Mother name is required";
...
if (!isValidFile(files.signature))
  err.signature = "Signature required";

if (!isValidFile(files.idProof))
  err.idProof = "ID proof required";

if (!isValidFile(files.lastMarksheet))
  err.lastMarksheet = "Last marksheet required";

    if (!form.declarationLocation)
      err.declarationLocation =
        "Declaration location is required";

    if (!form.declarationAccepted)
      err.declarationAccepted =
...
const submitForm = async (e) => {
  ...
  try {
    ...
    formData.append(
      "hostelRequired",
      form.hostelRequired ? "true" : "false"
    );

    // 🔴 YAHIN lagao (IMPORTANT)
    formData.append(
      "declarationLocation",
      form.declarationLocation
    );
    formData.append(
      "declarationAccepted",
    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-gray-50 to-blue-50 p-4">
      <div className="bg-white p-8 rounded-2xl shadow-xl max-w-md w-full text-center">
        ...
        <p className="text-gray-600 leading-relaxed mb-6"style={{fontFamily:"Poppins"}}>
          You have already successfully submitted your admission form. 
        ...
        <button
          ...
          className="w-full bg-blue-600 text-white py-3 rounded-lg font-semibold"style={{fontFamily:"Poppins"}}
        >
          View Submitted Form
        </button>
      </div>
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50 py-12 px-4 sm:px-6 lg:px-8">
      ...
      <div className="max-w-5xl mx-auto">
        ...
        <div className="text-center mb-10">
          ...
          <div className="mt-4 h-1 w-32 bg-gradient-to-r from-blue-600 to-indigo-600 mx-auto rounded-full"></div>
        </div>

        {/* Form Card */}
        <form onSubmit={submitForm} className="bg-white rounded-2xl shadow-2xl overflow-hidden">
          {/* Progress Bar */}
          <div className="h-2 bg-gradient-to-r from-blue-600 via-indigo-600 to-purple-600"></div>
          
          <div className="p-8 sm:p-12">
            {/* Terms and Conditions */}
            <div className="mb-10 p-6 bg-blue-50 border-l-4 border-blue-600 rounded-r-lg">
              <TermsAndConditions
            ...
            >
              ...
              <Select
                ...
                onChange={handleChange}
                options={["PRIMARY 1","PRIMARY 2","PRIMARY 3","PRIMARY 4","PRIMARY 5","AALIMA","FAZILA"]}
              ...
              <div className="md:col-span-2">
                <label className="flex items-start gap-3 p-4 border-2 border-gray-200 rounded-lg hover:border-blue-400 transition-colors cursor-pointer">
                  ...
                  <span className="text-sm text-gray-700 leading-relaxed">
                    I hereby declare that all the information provided above is true and correct to the best of my knowledge. I understand that any false information may lead to the rejection of this application.
                  </span>
                </label>
  ...
  <div className="fixed inset-0 z-50 bg-black/60 flex items-center justify-center px-4">
    <div className="bg-white max-w-4xl w-full rounded-2xl shadow-2xl overflow-y-auto max-h-[90vh]">
      ...
      <div className="p-6 space-y-6 text-sm text-gray-800">
        ...
        {/* STUDENT DETAILS */}
        <section>
          <h3 className="font-semibold text-base mb-2 border-b pb-1"style={{fontFamily:"Poppins"}}>
            Student Details
          </h3>
          <div className="grid grid-cols-2 gap-3"style={{fontFamily:"Poppins"}}>
            <p><b>Name:</b> {form.studentName}</p>
            <p><b>DOB:</b> {form.dob}</p>
            <p><b>Gender:</b> {form.gender}</p>
            <p><b>Class:</b> {form.classApplied}</p>
          </div>
        </section>
        ...
        <section>
          ...
          <div className="grid grid-cols-2 gap-3"style={{fontFamily:"Poppins"}}>
            <p><b>Father:</b> {form.fatherName}</p>
            <p><b>Mother:</b> {form.motherName}</p>
            <p><b>Guardian:</b> {form.guardianName}</p>
            <p><b>Relation:</b> {form.guardianRelation}</p>
          </div>
        </section>
        ...
        <section>
          ...
          <div className="flex gap-6">
            ...
            {files.studentSignature && (
              <div>
                <p className="mb-1 font-medium"style={{fontFamily:"Poppins"}}>Signature</p>
                <img
      ...
      <div className="flex justify-end gap-4 px-6 py-4 border-t bg-gray-50">
        <button
          onClick={() => setShowPreview(false)}
          className="px-5 py-2 rounded bg-gray-500 text-white"style={{fontFamily:"Poppins"}}
        >
          Edit
        </button>
        ...
        <button
          onClick={submitForm}
          className="px-5 py-2 rounded bg-green-600 text-white"style={{fontFamily:"Poppins"}}
        >
          Final Submit
        </button>
      </div>
        ...
        {/* Footer */}
        <div className="text-center mt-8 text-gray-600 text-sm"style={{fontFamily:"Poppins"}}>
...
function FileInput({ label, name, onChange, error, required, accept }) {
  ...
  return (
    <div className="space-y-2">
      ...
      <div className={`relative border-2 border-dashed rounded-lg p-4 transition-all duration-200 hover:border-blue-400 ${
        ...
        <div className="text-center">
          ...
          {fileName ? (
            <p className="mt-2 text-sm text-gray-700 font-medium truncate">{fileName}</p>
          ) : (
            <>
              <p className="mt-2 text-sm text-gray-600">
                <span className="font-semibold text-blue-600"style={{fontFamily:"Poppins"}}>Click to upload</span> or drag and drop
              </p>
              <p className="text-xs text-gray-500 mt-1"style={{fontFamily:"Poppins"}}>JPG, PNG or PDF (max. 2MB)</p>
            </>
          )}
        </div>
      </div>
